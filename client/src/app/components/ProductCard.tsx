// nama botol, tempat, waktu, deskripsi
    ...
    return (
        <div className="h-[472px] w-[288px] p-3 bg-whiteBg rounded-lg shadow border border-[#e8e8e8] flex flex-col justify-start items-start gap-2">
            <div className="h-[264px] w-[264px] bg-white rounded-[10px] flex justify-end items-center overflow-hidden">
                <img className="w-full h-full object-cover" src={product.imageUrl} alt={product.name}></img>
            </div>
            <div className="px-2 pt-2 pb-1 flex flex-col justify-start items-start gap-4">
                ...
                <Button variant="default" className="bg-lightBlue1 w-full">Buka Detail</Button>
            </div>
        </div>       
    )
}
